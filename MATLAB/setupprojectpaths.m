...
% Add matlab-utilities folder from GitProjects/
USRDirStart = strfind(CurDir, 'andrew');
USRDir = CurDir(1:USRDirStart + 5);

addpath('/media/andrew/WDRhodes/GitProjects/matlab-utilities/')
