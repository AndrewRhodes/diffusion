...
% FileLocationPoints = strcat(ProjectRoot,'/data/circle/CPGauss/');
% FileNamePoints = strcat('Points','_NumPoints',num2str(NumCirclePoints),'_p',num2str(porder),'_s',num2str(spacing),'_NumSigma',num2str(numsigmas),'.mat');
