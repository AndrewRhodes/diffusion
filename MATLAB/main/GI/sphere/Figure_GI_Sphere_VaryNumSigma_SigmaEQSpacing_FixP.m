...
for MCsigma = 1 : length(MCnumsigma)
    ...
    for MCs = 1 : length(MCspacing)
        ...
        clearvars -except MCspacing MCs MCnumsigma MCsigma MCError MCErrorAll ProjectRoot
...
%         FileNameIJK = strcat('IJK','_NumDiv',num2str(NumberDivisions),'_p',num2str(porder),'_s',num2str(spacing),'_NumSigma',num2str(numsigmas),'.mat');
        ...
        FileNameCP = strcat('CP','_NumPoints',num2str(NumSpherePoints),'_p',num2str(porder),'_s',num2str(spacing),'_NumSigma',num2str(numsigmas),'.mat');
        FileNameIJK = strcat('IJK','_NumPoints',num2str(NumSpherePoints),'_p',num2str(porder),'_s',num2str(spacing),'_NumSigma',num2str(numsigmas),'.mat');
...
%         FileNameG = strcat('G','_NumDiv',num2str(NumberDivisions),'_p',num2str(porder),'_s',num2str(spacing),'_NumSigma',num2str(numsigmas),'_LimitFar',num2str(LimitFarPoints),'.mat');
        ...
        FileNameEcp = strcat('Ecp','_NumPoints',num2str(NumSpherePoints),'_p',num2str(porder),'_s',num2str(spacing),'_NumSigma',num2str(numsigmas),'.mat');
        FileNameEplot = strcat('Eplot','_NumPoints',num2str(NumSpherePoints),'_p',num2str(porder),'_s',num2str(spacing),'_NumSigma',num2str(numsigmas),'.mat');
        FileNameGCart = strcat('GCart','_NumPoints',num2str(NumSpherePoints),'_p',num2str(porder),'_s',num2str(spacing),'_NumSigma',num2str(numsigmas),'_LimitFar',num2str(LimitFarPoints),'.mat');
        FileNameG = strcat('G','_NumPoints',num2str(NumSpherePoints),'_p',num2str(porder),'_s',num2str(spacing),'_NumSigma',num2str(numsigmas),'_LimitFar',num2str(LimitFarPoints),'.mat');
...
%         end
        ...
        [SphereX, SphereY, SphereZ] = sphere(NumSpherePoints);
        Sphere.Location = [SphereX(:), SphereY(:), SphereZ(:)];
...
% % % 0.5th Order Line
logx = [10,40];
logy = (10*10^(-3.5)).*logx.^(-0.5);
loglog(logx, logy,'k-','linewidth',3)

% xl=get(gca,'XLim');
% yl=get(gca,'YLim');
text1 = text(12,10*10^(-4.3),'$0.5^{th}$ Order','Interpreter','latex');
...
set(hleg, 'position', [0.78 0.5 0.07 0.2], 'FontSize', 50)
