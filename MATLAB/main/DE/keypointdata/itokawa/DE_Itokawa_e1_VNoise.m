...
for j = 1 : length(NoiseVec)
    ...
    load(strcat('ItokawaCurvature_e1_80000_sigma',num2str(j),'.mat'))
    ...
    save(strcat('ItokawaItL_e1_80000_sigma',num2str(j),'.mat'),'ItL','v7.3')
    
    % load(strcat('ItokawaItL_e1_80000_sigma',num2str(j),'.mat'))
