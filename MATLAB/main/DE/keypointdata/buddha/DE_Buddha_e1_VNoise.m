...
for j = 1 : length(NoiseVec)
    ...
    load(strcat('BuddhaCurvature_e1_50000_sigma',num2str(j),'.mat'))
...
for i = 1
    ...
    %
    % ply_write('Buddha_e1_50000_sigma5.ply', PointCloud.Face, PointCloud.Location)
    % save_off(PointCloud.Location, PointCloud.Face, 'Buddha_e1_50000_sigma5.off')
