...
%             [VerticesOut, FacesOut] = clearMeshDuplicates(Location, Faces );
        ...
        FileNameItL = strcat(FileLocation, 'umbrella/Icosphere_div',num2str(NumberDivisions),...
            '_ItL','_BDF',num2str(BDF),'.mat');
        
        
        if ~exist(FileNameItL, 'file')            
            ItL = makeUmbrellaLaplaceBeltrami(Sphere, Neighbors.Connect, tau, alpha, BDF);
...
save(strcat(FileLocation,'umbrella/MCErrorAll.mat'), 'MCErrorAll', '-v7.3')
