...
%         clearvars -except MCp MCs MCporder MCspacing Lorder PointCloud spacing porder Band x1d y1d z1d CP FileLocationCP FileNameL FileNameEplot FileNameEcp FileNameM% MCError MCErrorAll
